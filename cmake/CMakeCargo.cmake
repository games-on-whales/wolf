function(cargo_build)
    ...
    elseif(CMAKE_SYSTEM_NAME STREQUAL Darwin)
        ...
        option(CARGO_TARGET_BUILD "Custom set the --target  option for cargo, ex: aarch64-unknown-linux-gnu")
        if(DEFINED CARGO_TARGET_BUILD)
            set(LIB_TARGET ${CARGO_TARGET_BUILD})
    ...
    message(STATUS "Linking to Rust library: ${LIB_FILE}")
