...
One last final check: we have to make sure that the `nvidia-drm` module has been loaded...
...
.I don't see that, how do I load the module?
[%collapsible]
====
...
...and make sure that the module is loaded with the flag `modeset=1`.
[source,bash]
....
...
.I don't have that, how do I set the flag?
[%collapsible]
====
