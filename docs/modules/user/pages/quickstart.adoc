...
* Make sure to install https://docs.nvidia.com/datacenter/cloud-native/container-toolkit/latest/install-guide.html[NVIDIA Container Toolkit]

We also have to make sure that the `nvidia-drm` module has been loaded and that is loaded with the flag `modeset=1`.
...
You can check if the driver is loaded by issuing `nvidia-smi` inside the container:
[source,bash]
....
docker exec -it wolf nvidia-smi
+---------------------------------------------------------------------------------------+
...
|                                         |                      |               MIG M. |
|=========================================+======================+======================|
|   0  NVIDIA GeForce RTX 3070         On | 00000000:0A:00.0 Off |                  N/A |
|  0%   47C    P8               16W / 220W|    416MiB /  8192MiB |      0%      Default |
|                                         |                      |                  N/A |
+-----------------------------------------+----------------------+----------------------+
