...
`reboot` you PVE host and try running `ls -l /dev/nvidia*` again.
====
...
Our PVE host setup is now complete, you must follow the normal instructions inside your LXC to run Wolf.
xref:#nvidia-manual-tab[Nvidia Manual]
