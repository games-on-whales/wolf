...
[WARNING,caption=OUTDATED]
====
This section is outdated, we now support outputting DMA buffers in Gstreamer and we've achieved *full support for zero-copy pipelines*!
====
